...
public class ChipInfo {
    ...
    public static boolean shouldIgnoreVoltTable(type type) {
        return type == ChipInfo.type.lahaina || type == ChipInfo.type.lahaina_singleBin
                ...
                || type == ChipInfo.type.cliffs_singleBin || type == ChipInfo.type.cliffs_7_singleBin
                || type == ChipInfo.type.kalama_sg_singleBin || type == ChipInfo.type.sun
                || type == ChipInfo.type.blair || type == ChipInfo.type.holi;
    }
    ...
    public static String name2chipdesc(type t, Activity activity) {
        switch (t) {
            ...
            case blair:
                return activity.getResources().getString(R.string.blair);
            case holi:
                return activity.getResources().getString(R.string.holi);
        }
    ...
    public static class rpmh_levels {
        public static int[] levels() {
            ...
            else if (ChipInfo.which == type.blair)
                return rpmh_levels_blair.levels;
            else if (ChipInfo.which == type.holi)
                return rpmh_levels_holi.levels;    
        ...
        public static String[] level_str() {
            if (ChipInfo.which == type.kona || ChipInfo.which == type.kona_singleBin)
                ...
                return rpmh_levels_blair.level_str;
            else if (ChipInfo.which == type.holi)
                return rpmh_levels_holi.level_str;    
    ...
    private static class rpmh_levels_blair {
        public static final int[] levels = {16, 48, 56, 64, 80, 96, 128, 144, 192, 224, 256, 320,
                336, 352, 384, 400, 416, 432, 448, 464};
        public static final String[] level_str = {
                "RETENTION",
    ...
    private static class rpmh_levels_holi {
        public static final int[] levels = {16, 48, 56, 64, 80, 96, 128, 144, 192, 224, 256, 320,
                336, 352, 384, 400, 416, 432, 448, 464};
        public static final String[] level_str = {
                "RETENTION",
